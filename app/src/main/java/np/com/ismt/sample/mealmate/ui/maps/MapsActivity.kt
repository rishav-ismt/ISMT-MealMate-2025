package np.com.ismt.sample.mealmate.ui.maps
...
import np.com.ismt.sample.mealmate.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(),
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == 101 && allPermissionForLocationGranted()) {
            ...
            HelperUtil.showToastMessage(this, "Please provide permission for SMS")
        }
    }
